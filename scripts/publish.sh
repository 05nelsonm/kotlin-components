...
case $1 in
  ...
  "--host")
    ...
    case $2 in
      ...
      "darwin")
        TARGETS="-PKMP_TARGETS=IOS_ARM32,IOS_ARM64,IOS_X64,MACOS_ARM64,MACOS_X64,TVOS_ARM64,TVOS_X64,WATCHOS_ARM32,WATCHOS_ARM64,WATCHOS_X64,WATCHOS_X86,IOS_SIMULATOR_ARM64,TVOS_SIMULATOR_ARM64,WATCHOS_SIMULATOR_ARM64"
        sync "$TARGETS"
